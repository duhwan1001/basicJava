...
public class RepetitiveStatement {
	...
	public static void main(String[] args) {
		...
		/*
		 * for(int i = 1; i <= 9; i++){ System.out.println("2 * " + i + " = " +
		 * i * 2); }
		 * 
		...
		// 숫자 맞추기 게임
		/*
		 * int answer = (int)(Math.random() * 100) + 1; //1 ~ 100랜덤수 int input
		 * =0; Scanner s = new Scanner(System.in); do{
